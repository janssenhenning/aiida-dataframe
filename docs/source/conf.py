#
# Sphinx configuration for aiida-dataframe
#
...
project = "aiida-dataframe"
copyright_first_year = "2022"
copyright_owners = "Henning Janßen"
...
release = aiida_dataframe.__version__
...
html_title = f"aiida-dataframe v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-dataframe.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_dataframe")
